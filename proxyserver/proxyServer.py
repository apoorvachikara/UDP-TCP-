    ...
    # Error handling for file not found in cache
            ...
            # Create a socket on the proxy server
                ...
                # Connect to the socket to port 80
                    c.connect((hostn,80))
                    print('Socket is connected to port 80 of the host')
                ...
                # Creating a new file in the cache for the requested file.
                # It also sends the response in the buffer to client socket and corresponding file in the cache
                    tmpFile = open("./" + filename,"wb")
                    
                # Fetching data from buff and wrting it to tmp file
